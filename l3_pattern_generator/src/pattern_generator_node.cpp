#include <l3_pattern_generator/pattern_generator_node.h>
...
void PatternGeneratorNode::setParams(const msgs::PatternGeneratorParametersConstPtr& params) { pattern_generator.setParams(*params); }
...
{
  pattern_generator.updateFirstChangeableStepIndex(feedback->first_changeable_step_idx);
}
...
{
  ros::init(argc, argv, "l3_pattern_generator");
  ros::NodeHandle nh;
  l3_footstep_planning::PatternGeneratorNode patternGeneratorNode(nh);
  ros::spin();
