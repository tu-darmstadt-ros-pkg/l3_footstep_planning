...
TEST(Typedefs, Transition)
{
  ...
  Transition t(FootStepAction::ConstPtr(), s1_ptr, s2_ptr, 0.2, 0.1);
...
TEST(Database, TransitionDataBase)
{
  ...
  Transition t1(FootStepAction::ConstPtr(), s1_ptr, s2_ptr, 0.2, 0.1);
  ...
  Transition t2(FootStepAction::ConstPtr(), s2_ptr, s3_ptr, 0.14, 0.01);
  ...
  Transition t3(FootStepAction::ConstPtr(), s1_ptr, s4_ptr, 0.05, 0.11);
  ...
  Transition t4(FootStepAction::ConstPtr(), s4_ptr, s2_ptr, 0.4, 0.1);
